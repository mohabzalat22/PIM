...
export default function InviteSignInPage() {
  ...
  // Build the redirect URL to return to the invitation after sign-in
      ...
      <div className="w-full max-w-4xl space-y-6">
        ...
        <div className="flex items-center justify-center">
          <SignIn 
            ...
            signUpUrl={`/invite/sign-up?token=${token}&workspace=${encodeURIComponent(workspaceName)}&role=${role}`}
          />
        </div>
      </div>
    </div>
